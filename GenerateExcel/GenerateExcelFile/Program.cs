...
namespace GenerateExcelFile
{
    class Program
    {
        ...
        {
            string fileName = string.Format(@"C:\Users\Chinnu\source\repos\UAECovidAPI\GenerateExcel\GenerateExcel\ExcelFiles\{0}", DateTime.Now.ToString("ddMMyyyyHHmmss") + ".xlsx");
